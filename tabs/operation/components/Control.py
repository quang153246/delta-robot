...
class Control():
    def __init__(self, parent) -> None:
        ...
        self.startButton = ToggleButton(self.control_content, Title= "Start", BackGround= self.__ui_colour.GREEN_DARK, SubBackGround= self.__ui_colour.GRAY_MAIN, TextColor= self.__ui_colour.WHITE, State= False, TextSize=15)
        self.stopButton = ToggleButton(self.control_content, Title= "Stop", BackGround= self.__ui_colour.RED_DARK, SubBackGround= self.__ui_colour.GRAY_MAIN, TextColor= self.__ui_colour.WHITE, State=True, TextSize=15)
        ...
        control_content_layout_v.Add(self.select_label.GetObject(), 1, wx.EXPAND|wx.BOTTOM, 10)
        control_content_layout_v.Add(self.startButton.GetObject(), 3, wx.EXPAND|wx.BOTTOM, 10)
        control_content_layout_v.Add(self.stopButton.GetObject(), 3, wx.EXPAND|wx.TOP, 10)
        control_content_layout_h.Add(control_content_layout_v, 1,  wx.EXPAND|wx.LEFT|wx.RIGHT, 40)
        
        control_content_layout_sub.Add(control_content_layout_h, 1, wx.EXPAND|wx.BOTTOM, 20)
        ...
        control_tab_layout.Add(self.control_box, 1, wx.EXPAND|wx.ALL, 0)
        control_tab_layout.Add(self.status_box, 5, wx.EXPAND|wx.ALL, 0)
